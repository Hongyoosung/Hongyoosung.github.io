...
{{< side-by-side src="/images/project2/main.png" caption="Fig 1. 3계층 프레임워크 구조" width="md:w-1/2" align="left">}}
...
하위 수준의 의사결정(전술)을 담당합니다. 내부는 상태 그래프로 구성되어 있으며, 각 상태에는 실행할 수 있는 Action이 존재합니다. 
그래프에는 시작 상태와 목표 상태가 존재하는데, Planner Node는 목표 상태에 도달하기 위한 Action 체인을 제공합니다.
...
{{< code lang="csharp" label="Interface-based extensibility (OCP compliance)" width="96%" height="300px" align="right" >}}
...
{{< code lang="csharp" label="Time-slicing" width="96%" height="400px" align="right" >}}
...
{{< code lang="csharp" label="Visited List & Stickiness" width="96%" height="400px" align="right" >}}
...
{{< code lang="csharp" label="Object Pooling" width="96%" height="400px" align="right" >}}
