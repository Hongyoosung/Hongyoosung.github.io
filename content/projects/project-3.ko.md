...
{{< side-by-side src="/images/project3/sensor.png" caption="그림 3. 실험에 사용된 센서" >}}
...
{{< img-grid 
    src1="/images/project3/case1.png" cap1="그림 6. 최적화 전(블로킹 발생)"
    src2="/images/project3/case2.png" cap2="그림 7. 최적화 후(비동기 처리)"
    class="max-w-full" 
>}}
...
## 결과
* [한국스마트미디어학회 2024년 4월호 4권 ‘IoT 가상환경 플랫폼에서의 무결성 보장 시스템:HyperledgerIndy와 MQTT를 통하여’ ](https://kism.or.kr/file/memoir/13_4_8.pdf) 제 1저자
