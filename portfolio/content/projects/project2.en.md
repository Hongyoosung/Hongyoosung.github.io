...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8 items-start"><figure class="flex flex-col items-center"><img src="/images/project2/statenode.png" alt="image 1" class="max-w-full w-3/4 rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Figure 2. Action selection process. The agent retains the aftereffect of the selected action as its current state.</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project2/stategraph.png" alt="image 2" class="max-w-full rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Figure 3. State Space Graph</figcaption></figure></div>
...
<figure class="flex flex-col items-center my-8"><img src="/images/project2/graph.png" alt="Utility Graph" class="max-w-3xl rounded-lg shadow-md mb-2 modal-trigger cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans">Figure 4. Normalization and Environment Response Curves</figcaption></figure>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-8 items-start"><figure class="flex flex-col items-center"><img src="/images/project2/unity1.png" alt="image 1" class="max-w-full aspect-video object-cover rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Figure 5. Custom Planner Node in Behavior Designer</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project2/action.png" alt="image 2" class="max-w-full aspect-video object-cover rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Figure 6. Inspector for Action Classes with Pre/Post-conditions</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project2/planner.png" alt="image 3" class="max-w-full aspect-video object-cover rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Figure 7. Inspector for setting Goal States and Evaluation Variables</figcaption></figure></div>
...
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Figure 8. Basic method (blocking occurs)</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project2/after.png" alt="image 2" class="max-w-full rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Figure 9. Coroutine time-sharing method</figcaption></figure></div>
