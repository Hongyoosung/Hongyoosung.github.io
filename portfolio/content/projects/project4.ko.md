...
<figure class="flex flex-col items-center my-8"><img src="/images/project4/DpkiClient.drawio.png" alt="개요 이미지" class="max-w-3xl rounded-lg shadow-md mb-2 modal-trigger cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans">Fig 1. 아키텍처 다이어그램</figcaption></figure>
...
<figure class="flex flex-col items-center my-8"><img src="/images/project4/vonnet.png" alt="본넷 이미지" class="max-w-xl rounded-lg shadow-md mb-2 modal-trigger cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans">Fig 2. VonNet에서 확인된 디바이스의 DID와 공개키</figcaption></figure>
...
<figure class="flex flex-col items-center my-8"><img src="/images/project4/sensor.png" alt="패킷 이미지" class="max-w-xl rounded-lg shadow-md mb-2 modal-trigger cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans">Fig 3. IoT 센서</figcaption></figure>
...
<figure class="flex flex-col items-center my-8"><img src="/images/project4/packet.png" alt="패킷 이미지" class="max-w-xl rounded-lg shadow-md mb-2 modal-trigger cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans">Fig 4. 사용된 메시지 포멧</figcaption></figure>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8 items-start"><figure class="flex flex-col items-center"><img src="/images/project4/unity.png" alt="image 1" class="w-full w-3/4 rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 5. 유니티 환경</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project4/avataUI.drawio.png" alt="image 2" class="w-full w-3/4 rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 6. 상호작용 시퀀스</figcaption></figure></div>
...
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 7. 최적화 전(블로킹 발생)</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project4/case2.png" alt="image 2" class="w-full w-3/4 rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 8. 최적화 후(비동기 처리)</figcaption></figure></div>
