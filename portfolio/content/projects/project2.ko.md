...
<img src="/images/project2/main.png" alt="" class="rounded-lg shadow-md w-full h-auto modal-trigger cursor-pointer">
...
Planner Node는 Behavior Tree 내에 존재하는 세부 전술 담당의 노드입니다. 상태 오브젝트를 노드에 할당하면 이후 사전조건, 사후효과 기반으로 상태 그래프가 구축됩니다. 에이전트는 런타임에 Planner Node가 실행될 경우 목표 상태에 도달하기 위한 상태 그래프를 구축하고 유틸리티 평가에 따라 상태를 전환해가면서 액션을 실행합니다.

<figure class="flex flex-col items-center my-8"><img src="/images/project2/stategraph.png" alt="스테이트 그래프" class="max-w-3xl rounded-lg shadow-md mb-2 modal-trigger cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans">Fig 3. State Space Graph</figcaption></figure>
...
<img src="/formula/project2/utilityformula.svg" class="project-math-svg" alt="Utility Formula">

<figure class="flex flex-col items-center my-8"><img src="/images/project2/statenode.png" alt="스테이트 노드 디테일" class="max-w-3xl rounded-lg shadow-md mb-2 modal-trigger cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans">Fig 2. 액션 선택 과정. 에이전트는 선택된 행동의 After-effect를 Current State로 갖는다.</figcaption></figure>

<figure class="flex flex-col items-center my-8"><img src="/images/project2/graph.png" alt="유틸리티 그래프" class="max-w-3xl rounded-lg shadow-md mb-2 modal-trigger cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans">Fig 4. 정규화와 미세 환경 변화 반응 그래프</figcaption></figure>
...
**Interface-based extensibility (OCP compliance)**
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-8 items-start"><figure class="flex flex-col items-center"><img src="/images/project2/unity1.png" alt="image 1" class="max-w-full w-full aspect-video object-cover rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 5. Behavior Designer 내에 배치된 커스텀 플래너 노드</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project2/action.png" alt="image 2" class="max-w-full w-full aspect-video object-cover rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 6. 사전조건/사후효과가 정의된 액션 클래스의 인스펙터 창</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project2/planner.png" alt="image 3" class="max-w-full w-full aspect-video object-cover rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 7. 커스텀 플래너 노드에서 목표 상태와 평가 상태변수를 설정하는 인스펙터 창</figcaption></figure></div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8 items-start"><figure class="flex flex-col items-center"><img src="/images/project2/before.png" alt="image 1" class="max-w-full rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 8. 기본 방식(블로킹 발생)</figcaption></figure><figure class="flex flex-col items-center"><img src="/images/project2/after.png" alt="image 2" class="max-w-full rounded-lg shadow-md mb-2 modal-trigger
cursor-pointer"><figcaption class="text-sm text-gray-500 italic font-sans text-center">Fig 9. 코루틴 시분할 방식</figcaption></figure></div>
